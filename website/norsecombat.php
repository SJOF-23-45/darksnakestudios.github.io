...
<body>
	<div id="header">
		<a href="index.php"><h1 align="left" id="titulo">|  Dark Snake Studios  |</h1></a>
	...
	<div class="topnav">
	  	...
	  	<a id="question" href="#" onmouseenter="javascript: questionmark()" onmouseleave="javascript: questionmarkleave()">?</a>
	...
	Norse Combat
	<p><a href="norsecombat.rar" download>
		Download Norse Combat versão Alpha!
	</a></p>
	<iframe src="https://i.simmer.io/@KastovGames/norse-combat" style="width:960px;height:600px;border:0"></iframe>
</div>
</body>
</html>